	...
	<div class="container">
		...
		<h1>goods insert</h1>
			<form action="/goods/insert" method="post">
				...
				<div class="form-group">
					<label for="gname">제품이름</label>
					<input name="gname" requeired id="gname" class="form-control">			
				</div>
				
				<div class="form-group">
					<label for="price">제품가격</label>
					<input name="price" requeired id="price" class="form-control">			
				</div>
			...
			<div class="form-group">
				...
				<button class="btn btn-primary" id="gnoCheck">제품번호 중복 체크</button>	
			</div>
